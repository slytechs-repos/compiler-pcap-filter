package com.slytechs.jnet.jnetpcap.bpf.compiler.ir;
...
public class IRBuilder implements BpfIR {
	...
	private void resolveLabels() throws CompilerException {
		...
		for (int i = 0; i < instructions.size(); i++) {
			...
			if (false
					...
					|| opcode == BpfOpcode.JMP_JEQ_K
					|| opcode == BpfOpcode.JMP_JGT_K
					|| opcode == BpfOpcode.JMP_JGE_K
					|| opcode == BpfOpcode.JMP_JSET_K
	...
	/**
	 * @see com.slytechs.jnet.jnetpcap.bpf.compiler.ir.BpfIR#optimize()
	 */
	@Override
	...
	/**
	 * @see com.slytechs.jnet.jnetpcap.bpf.compiler.ir.BpfIR#validate()
	 */
	@Override
